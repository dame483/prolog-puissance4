...
minimax_ab(Board, Depth, MaxDepth, Alpha, Beta, 'x', BestCol, BestValue) :-
    ...
    max_value(Board, RankedMoves, Depth, MaxDepth, Alpha, Beta, none, -100001, BestCol, BestValue).
...
max_value(Board, [Col | Cols], Depth, MaxDepth,
    ...
    ( NewAlpha >= Beta -> BestCol = NewCol, BestVal = NewVal; max_value(Board, Cols, Depth, MaxDepth, NewAlpha, Beta, NewCol, NewVal, BestCol, BestVal)).
...
minimax_ab(Board, Depth, MaxDepth, Alpha, Beta, 'o', BestCol, BestValue) :-
    ...
    Moves \= [],
    rank_columns(Moves, RankedMoves),
    min_value(Board, RankedMoves, Depth, MaxDepth, Alpha, Beta, none, 100001, BestCol, BestValue).

min_value(_, [], _, _, _, _, BestCol, BestVal, BestCol, BestVal) :-
    !.

min_value(Board, [Col | Cols], Depth, MaxDepth, Alpha, Beta, CurrCol, CurrVal, BestCol, BestVal) :-
    ...
    ( NewBeta =< Alpha -> BestCol = NewCol, BestVal = NewVal; min_value(Board, Cols, Depth, MaxDepth, Alpha, NewBeta, NewCol, NewVal, BestCol, BestVal)).
